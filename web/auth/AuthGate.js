...
function iconSvg(id) {
  const icons = {
    ...
    playstation: `<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#fff" d="M9.7 3v14.2l3.1 1V6.4c0-.6.3-1 .8-.8.7.2.9.9.9 1.5v4.7c2.3 1.1 4.1 0 4.1-2.9 0-3-1.1-4.3-4.3-5.4C12.5 2.9 10.8 2.7 9.7 3Zm-1.5 9.7-3.7 1.4c-2.5.9-2.9 2.2-.9 2.9 1.9.6 5.2.5 7.7-.4v-2.2l-1.1.4c-1.1.4-2.7.5-3.6.2-.8-.3-.7-.8.3-1.2l1.3-.5v-.6Zm6 1.1v2.5l3.7-1.3c1-.4 1.2-.9.4-1.2-.8-.3-2.2-.2-3.3.2l-.8.3v-.5Z"/></svg>`,
    steam: `<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#fff" d="M12 2a10 10 0 0 0-9.8 8.1l5.4 2.2a3.1 3.1 0 0 1 1.8-.6l2.6-3.8a4 4 0 1 1 4 4h-.1l-3.8 2.7a3.2 3.2 0 0 1-6.2 1.1L2.5 14A10 10 0 1 0 12 2Zm4 4a2 2 0 1 0 0 4 2 2 0 0 0 0-4ZM8.8 13.4a1.6 1.6 0 1 0 0 3.2 1.6 1.6 0 0 0 0-3.2Z"/></svg>`,
    ...
    facebook: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="12" fill="#1877F2"/><path fill="#fff" d="M13.6 20v-7h2.4l.4-2.8h-2.8V8.4c0-.8.2-1.4 1.4-1.4h1.5V4.5c-.3 0-1.2-.1-2.2-.1-2.2 0-3.7 1.3-3.7 3.8v2.1H8.5V13H11v7h2.6Z"/></svg>`,
    ...
    wechat: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="10" cy="10" r="7" fill="#07C160"/><circle cx="15.5" cy="15" r="6" fill="#07C160"/><circle cx="7.5" cy="8.5" r="1" fill="#fff"/><circle cx="12" cy="8.5" r="1" fill="#fff"/><circle cx="13.5" cy="13.5" r=".8" fill="#fff"/><circle cx="17.5" cy="13.5" r=".8" fill="#fff"/></svg>`,
    qq: `<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#12B7F5" d="M12 2c-3.8 0-6.3 3.3-6.3 7.4 0 .9.1 1.8.4 2.6-1.2 1.2-2 2.8-2 4.3 0 .8.3 1.3.8 1.3.4 0 .9-.3 1.5-.8.6 3 2.6 5.2 5.6 5.2s5-2.2 5.6-5.2c.6.5 1.1.8 1.5.8.5 0 .8-.5.8-1.3 0-1.5-.8-3.1-2-4.3.3-.8.4-1.7.4-2.6C18.3 5.3 15.8 2 12 2Z"/></svg>`,
    line: `<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="6" fill="#06C755"/><path fill="#fff" d="M6 8h2v6H6zm3 0h2v6H9zm3 0h2l2 3V8h2v6h-2l-2-3v3h-2z"/></svg>`,
...
export class AuthGate {
  constructor(container, onAuthenticated) {
    ...
    this.element.innerHTML = `<div class="auth-card">
      ...
      <div class="auth-account-actions"><button type="button" data-account="register">Załóż konto</button><button type="button" data-account="login">E-mail i hasło</button><button type="button" data-account="reset">Nie pamiętam hasła</button></div>
      ...
      <p class="auth-note" data-auth-note>${authBackendConfigured() ? "Połączenie z serwerem kont jest skonfigurowane." : "Tryb gościa działa od razu. Rejestracja, reset hasła i logowanie zewnętrzne wymagają publicznego serwera uwierzytelniania."}</p>
    </div>`;
